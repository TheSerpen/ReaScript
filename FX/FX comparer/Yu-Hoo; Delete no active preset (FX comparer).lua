...
if Ret>0 then
  ...
  if Item==-1 then
    if reaper.TrackFX_GetOpen(Track,FX) or IgnoreVisible then
      ...
      reaper.SetProjExtState(0,"YUHOO_FX_A/B_COMPARER",GUID,"")
      ...
      reaper.Undo_EndBlock2(0,"FX comparer: Delete preset: "..Name..": "..FX,-1)
    end
  else
    ...
    if reaper.TakeFX_GetOpen(Take,FX) or IgnoreVisible then
      ...
      FX=YH.GetOnlyFXName(FX)
      reaper.Undo_EndBlock2(0,"FX comparer: Delete preset: Item on track "..Name..": "..FX,-1)
    end
  end
end
